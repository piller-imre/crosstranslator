...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short _production_table[][] = 
    ...
    "\004\000\002\003\002\000\002\004\005" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\011\000\006\002\ufffe\004\004\001\002\000\004\005" +
    "\012\001\002\000\006\002\ufffe\004\004\001\002\000\004" +
    "\002\001\001\002\000\004\002\010\001\002\000\004\002" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\011\000\010\002\006\003\005\004\004\001\001\000" +
      ...
      switch (CUP$Parser$act_num)
		...
		List<ClassExpression> cl = (List<ClassExpression>)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 ...
		 RESULT = new LinkedList<ClassExpression>(); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // cls ::= CREATE IDENTIFIER END 
            {
		...
		Object i = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = new ClassExpression(i.toString()); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("cls",2, ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)), ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()), RESULT);
            }
          return CUP$Parser$result;
